...
func (r ApiSuppressionsBouncesImportPostRequest) InlineObject1(inlineObject1 InlineObject1) ApiSuppressionsBouncesImportPostRequest {
...
func (a *SuppressionsApiService) SuppressionsBouncesImportPostExecute(r ApiSuppressionsBouncesImportPostRequest) (*http.Response, error) {
	...
	if r.inlineObject1 == nil {
		return nil, reportError("inlineObject1 is required and must be specified")
	}
...
func (r ApiSuppressionsComplaintsImportPostRequest) InlineObject2(inlineObject2 InlineObject2) ApiSuppressionsComplaintsImportPostRequest {
...
func (r ApiSuppressionsUnsubscribesImportPostRequest) InlineObject3(inlineObject3 InlineObject3) ApiSuppressionsUnsubscribesImportPostRequest {
...
func (a *SuppressionsApiService) SuppressionsUnsubscribesImportPostExecute(r ApiSuppressionsUnsubscribesImportPostRequest) (*http.Response, error) {
	...
	if r.inlineObject3 == nil {
		return nil, reportError("inlineObject3 is required and must be specified")
	}
